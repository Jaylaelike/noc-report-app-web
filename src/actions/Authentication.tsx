...
export async function signin(
  ...
  const existingUser = await checkExistingUser(username, await getDb());
...
//   //insert Datetime when user login to the database sessions field last_login
//   const db = await getDb();
//   await db
//     ?.update(users)
...
export async function logout(): Promise<ActionResult> {
  ...
  //For if you want delete the session database
