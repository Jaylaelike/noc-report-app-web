...
export default function MainForm() {
  ...
  const [staTionData, staTionNames, emailsData, reporterUsers] =
    // eslint-disable-next-line react-hooks/rules-of-hooks
    useQueries({
      queries: [
        {
          ...
          <Card>
            <CardHeader>
              ...
              <select
                ...
                className="input-warning w-full max-w-xs p-5 text-gray-500"
              >
                <option value="บริษัท อาร์เอส มัลติมีเดีย จำกัด">open</option>
                <option value="บริษัท บีอีซี-มัลติมีเดีย จำกัด">close</option>
              </select>
            </CardHeader>
